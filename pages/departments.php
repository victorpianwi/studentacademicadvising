...
<head>
    ...
    <title>Departments || Student Academic Advisory System</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title">All Departments
                                            <div class="float-right">
                                                <div class="text-center">
                                                    <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-center">Add Department</button>
                                                </div>
                                                <div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Add Department</h5><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                            </div>
                                                                ...
                                                                <div class="">
                                                                    <form id="form">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control" required="" placeholder="Enter Department Name" onblur="this.setCustomValidity('')" oninput="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Department Name is required!')" name="dep_name">
                                                                        </div>

                                                                        <div class="form-group">
                                                                            <label>Faculty</label>
                                                                            <input type="text" class="form-control" required="" placeholder="Enter Faculty Name" onblur="this.setCustomValidity('')" oninput="this.setCustomValidity('')" oninvalid="this.setCustomValidity('Faculty Name is required!')" name="fac_name">
                                                                        </div>
